...
print('Frequency calculated based on signal provided for a',distance,'cm overhang is', frequencyv,'Hz')
...
Ev = round((E/10**9), 2)
print('Youngs Modulus calculated based on signal provided for a',distance,'cm overhang is', Ev,'GPa')


#plots the signal against time.
plt.scatter(filtered_Scatterx,[0]*len(filtered_Scatterx), color='blue', zorder=5, linewidths= 1, marker = 'x')
